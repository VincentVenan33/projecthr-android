...
class PerjalananDinasEditService {
  final url = 'http://192.168.2.155:8000/perjalanan_dinas/update';
  Dio dio = Dio();

  Future perjalananDinasEdit(int id, String judul, String tanggalAwal,
