...
class PerjalananDinasDeleteService {
  final url = 'http://192.168.2.155:8000/perjalanan_dinas/delete';
  Dio dio = Dio();

  Future perjalananDinasDelete(int id, BuildContext context) async {
    try {
