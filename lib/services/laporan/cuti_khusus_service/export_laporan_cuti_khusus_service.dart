...
class DownloadLaporanCutiKhususService {
  final url = 'http://192.168.2.155:8000/laporan/cuti_khusus/export';
  Dio dio = Dio();

  Future downloadLaporanCutiKhusus(
    int id,
    ...
    try {
      ...
      print('LIST CUTI KHUSUS : ${response.statusCode}');
