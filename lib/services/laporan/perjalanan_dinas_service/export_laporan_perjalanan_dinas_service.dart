...
class DownloadLaporanPerjalananDinasService {
  final url = 'http://192.168.2.155:8000/laporan/perjalanan_dinas/export';
  Dio dio = Dio();

  Future downloadLaporanPerjalananDinas(
    int id,
    ...
    try {
      ...
      print('LIST CUTI TAHUNAN : ${response.statusCode}');
