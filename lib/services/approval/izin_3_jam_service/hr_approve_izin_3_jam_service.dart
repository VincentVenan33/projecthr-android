...
class HrApproveIzin3JamService {
  final url = 'http://192.168.2.155:8000/ijin_3_jam/approver/approved';
  Dio dio = Dio();
  Future hrApproveIzin3Jam(int id, BuildContext context) async {
    try {
