...
class HRPerjalananDinasConfirmService {
  final url = 'http://192.168.2.155:8000/perjalanan_dinas/hr/confirm';
  Dio dio = Dio();

  Future hrperjalananDinasConfirm(int id, BuildContext context) async {
    try {
