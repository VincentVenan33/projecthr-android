...
class HRPerjalananDinasEditService {
  final url = 'http://192.168.2.155:8000/perjalanan_dinas/hr/update';
  Dio dio = Dio();

  Future hrperjalananDinasEdit(int id, String judul, String tanggalAwal,
