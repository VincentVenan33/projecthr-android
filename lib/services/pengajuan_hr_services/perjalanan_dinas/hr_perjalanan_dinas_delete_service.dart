...
class HRPerjalananDinasDeleteService {
  final url = 'http://192.168.2.155:8000/perjalanan_dinas/hr/delete';
  Dio dio = Dio();

  Future hrperjalananDinasDelete(int id, BuildContext context) async {
    try {
