...
import '../../../color.dart';
import '../../../services/pengajuan/cuti_khusus_service/cuti_khusus_detail.dart';
import '../../../util/customappbar.dart';
import '../../../util/navhr.dart';
import '../../services/pengajuan/cuti_khusus_service/cuti_khusus_corfirm_service.dart';
import '../../services/pengajuan/cuti_khusus_service/cuti_khusus_delete_attachment_service.dart';
import '../../services/pengajuan/cuti_khusus_service/cuti_khusus_download_service.dart';
import '../../services/pengajuan/cuti_khusus_service/cuti_khusus_edit_service.dart';
...
import '../pengajuan_cuti_khusus.dart';

class EditCutiKhusus extends StatefulWidget {
  final int id;
  const EditCutiKhusus({super.key, required this.id});
...
class _EditCutiKhususState extends State<EditCutiKhusus> {
  ...
  Future<void> fetchData() async {
    final result = await DetailCutiKhususService().detailCutikhusus(widget.id);

    dataCutiKhusus = result;
    DateTime? endData = DateTime.parse(dataCutiKhusus['tanggal_akhir']);
    DateTime? startDate = DateTime.parse(dataCutiKhusus['tanggal_awal']);
    ...
    tanggalAPIAwal = dataCutiKhusus['tanggal_awal'];
    ...
    tanggalAPIAkhir = dataCutiKhusus['tanggal_akhir'];
  ...
  Future<void> deleteAttachment(int index) async {
    ...
    final service = CutiKhususDeleteAttachmentService();
    await service.cutiKhususDeleteAttachment(
      idIjin,
      attachmentId,
      context,
    );
  ...
  void initState() {
    super.initState();
    fetchData();
    _futureData = DetailCutiKhususService().detailCutikhusus(widget.id)
      ...
      body: FutureBuilder<Map<String, dynamic>>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            final dataCutiKhusus = snapshot.data ?? {};
            return Form(
              key: formKey,
              child: ListView(
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        height: 35,
                        child: TextFormField(
                          enabled: dataCutiKhusus['status'] == 'Draft',
                      ...
                      Center(
                        child: isLoading
                            ...
                            : TextButton(
                                ...
                                onPressed: () {
                                  disabledUpload
                                          .contains(dataCutiKhusus['status'])
                                      ? null
                                      : pickFile();
                                },
                                child: Row(
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          ...
                          if (formKey.currentState!.validate()) {
                            ...
                            if (dataCutiKhusus['status'] == 'Draft') {
                              CutiKhususConfirmService()
                                  .cutiKhususConfirm(widget.id, context);
                              CutiKhususEditService().cutiKhususEdit(
                                widget.id,
