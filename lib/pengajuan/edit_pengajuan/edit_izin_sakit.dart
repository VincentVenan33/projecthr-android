...
import 'package:project/services/pengajuan/izin_sakit_services/data_edit_izin_sakit_services.dart';
import 'package:project/services/pengajuan/izin_sakit_services/delete_attachement_izin_sakit_services.dart';
import 'package:project/services/pengajuan/izin_sakit_services/download_attachement_izin_sakit_services.dart';
import 'package:project/services/pengajuan/izin_sakit_services/edit_izin_sakit_services.dart';
...
class EditIzinSakit extends StatefulWidget {
  final int id;
  const EditIzinSakit({super.key, required this.id});

  @override
  State<EditIzinSakit> createState() => _EditIzinSakitState();
}

class _EditIzinSakitState extends State<EditIzinSakit> {
  ...
  Future<void> fetchData() async {
    final result =
        await DataEditIzinSakitService().dataEditIzinSakit(widget.id);
  ...
  Future<void> deleteAttachment(int index) async {
    ...
    final services = DeleteAttachmentIzinSakit();
    await services.deleteAttachmentIzinSakit(idIzin, attachmentId);
    setState(() {
  ...
  void initState() {
    super.initState();
    fetchData();
    _futureData = DataEditIzinSakitService().dataEditIzinSakit(widget.id)
                        ...
                        onPressed: () {
                          ...
                          if (formKey.currentState!.validate()) {
                            ...
                            if (izinSakitList['status'] == 'Draft') {
                              IzinSakitConfirmServices().izinsakitconfirm(
                                widget.id,
                              );
                              EditizinSakitServices().editIzinSakit(
                                widget.id,
                                judulSakit.text,
                                tanggalAPIa,
                                tanggalAPIb,
