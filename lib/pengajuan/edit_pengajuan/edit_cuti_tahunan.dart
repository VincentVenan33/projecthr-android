...
import 'package:project/services/pengajuan/cuti_tahunan_services/data_edit_cuti_tahunan_services.dart';
import 'package:project/services/pengajuan/cuti_tahunan_services/delete_attachment_cuti_tahunan_services.dart';
import 'package:project/services/pengajuan/cuti_tahunan_services/download_attachment_cuti_tahunan_services.dart';
import 'package:project/services/pengajuan/cuti_tahunan_services/edit_cuti_tahunan_services.dart';
...
class EditCutiTahunan extends StatefulWidget {
  final int id;
  const EditCutiTahunan({super.key, required this.id});
...
class _EditCutiTahunanState extends State<EditCutiTahunan> {
  ...
  Future<void> fetchData() async {
    final result =
        await DataEditCutiTahunanServices().dataEditCutiTahunan(widget.id);
  ...
  Future<void> deleteAttachment(int index) async {
    ...
    final services = DeleteAttachmentCutiTahunanServices();
    await services.deleteAttachmentCutiTahunan(idIzin, attachmentId);
    setState(() {
  ...
  Future<void> downloadAttachment(int index, String filename) async {
    final attachmentId = fileData[index]['id'];
    final services = DownloadAttachmentCutiTahunanServices();
    await services.downloadAttachmenCutiTahunan(attachmentId, filename);
    setState(() {
      fileData.removeAt(index);
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
  ...
  void initState() {
    super.initState();
    fetchData();
    _futureData = DataEditCutiTahunanServices().dataEditCutiTahunan(widget.id);
  }
                        ...
                        onPressed: () {
                          ...
                          if (formKey.currentState!.validate()) {
                            ...
                            if (izinSakitList['status'] == 'Draft') {
                              ...
                              CutiTahunanEditServices().cutiTahunanEdit(
                                widget.id,
                                judulSakit.text,
                                tanggalAPIa,
                                tanggalAPIb,
