...
import 'package:project/detail/detail_pengajuan/detail_view/ijin_3_jam_detail.dart';
import 'package:project/services/pengajuan/izin_3_jam_service/cancelled_izin_3_jam_service.dart';
import 'package:project/services/pengajuan/izin_3_jam_service/delete_izin_3_jam_service.dart';
import 'package:project/services/pengajuan/izin_3_jam_service/izin_3_jam_list_service.dart';
import 'package:project/services/pengajuan/izin_3_jam_service/izin_3_jam_service.dart';

import '../color.dart';
import '../util/customappbar.dart';
import '../util/navkaryawan.dart';
import 'edit_pengajuan/edit_pengajuan_ijin_3_jam.dart';
...
class _PengajuanIzin3JamState extends State<PengajuanIzin3Jam> {
  ...
  Future<void> fetchData() async {
    ...
    final result = await Izin3JamListService().izin3JamList(
      page: page,
      tanggalAwal: tglAwal,
