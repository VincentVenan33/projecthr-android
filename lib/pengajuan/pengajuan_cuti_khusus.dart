...
import '../../color.dart';
import '../detail/detail_pengajuan/detail_view/cuti_khusus_detail.dart';
import '../services/pengajuan/cuti_khusus_service/cuti_khusus_cancelled_service.dart';
import '../services/pengajuan/cuti_khusus_service/cuti_khusus_delete_service.dart';
import '../services/pengajuan/cuti_khusus_service/cuti_khusus_input_service.dart';
import '../services/pengajuan/cuti_khusus_service/cuti_khusus_list_service.dart';
import '../util/customappbar.dart';
import '../util/navkaryawan.dart';
import 'edit_pengajuan/edit_cuti_khusus.dart';
...
class _PengajuanCutiKhususState extends State<PengajuanCutiKhusus> {
  ...
  Future<void> fetchData() async {
    ...
    final result = await CutiKhususListService().getCutiKhususList(
      page: page,
      tanggalAwal: tglAwal,
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        ElevatedButton(
                                                                          ...
                                                                          onPressed:
                                                                              () {
                                                                            Navigator.pop(context);
                                                                            CutiKhususDeleteService().cutiKhususDelete(dataCutiKhusus[index]['id'],
                                                                                context);
                                                                        ...
                                                                        Row(
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            ElevatedButton(
                                                                              ...
                                                                              onPressed: () {
                                                                                Navigator.pop(context);
                                                                                CutiKhususCancelledService().cutiKhususCancelled(
