...
import '../../color.dart';
import '../detail/detail_pengajuan/detail_view/perjalanan_dinas_detail.dart';
import '../services/pengajuan/perjalanan_dinas_service/perjalanan_dinas_cancelled_service.dart';
import '../services/pengajuan/perjalanan_dinas_service/perjalanan_dinas_delete_service.dart';
import '../services/pengajuan/perjalanan_dinas_service/perjalanan_dinas_input_service.dart';
import '../services/pengajuan/perjalanan_dinas_service/perjalanan_dinas_list_service.dart';
import '../util/customappbar.dart';
import '../util/navkaryawan.dart';
import 'edit_pengajuan/edit_perjalanan_dinas.dart';
...
class PengajuanPerjalananDinas extends StatefulWidget {
  ...
  @override
  State<PengajuanPerjalananDinas> createState() =>
      _PengajuanPerjalananDinasState();
}
...
class _PengajuanPerjalananDinasState extends State<PengajuanPerjalananDinas> {
  ...
  Future<void> fetchData() async {
    ...
    final result = await PerjalananDinasListService().getPerjalananDinasList(
      page: page,
      tanggalAwal: tglAwal,
                                            ...
                                            ElevatedButton(
                                              ...
                                              onPressed: () async {
                                                if (formkey.currentState!
                                                    .validate()) {
                                                  CutiPerjalananDinasInputService()
                                                      .cutiperjalanandinas(
