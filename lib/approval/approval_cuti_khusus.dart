...
import '../../color.dart';
import '../detail/Log/log_cuti_khusus.dart';
import '../detail/need_aprrove/need_confirm_cuti_khusus.dart';
import '../services/approval/cuti_khusus_service/cuti_khusus_list_service.dart';
import '../util/customappbar.dart';
import '../util/navhr.dart';

class ApprovalCutiKhusus extends StatefulWidget {
  const ApprovalCutiKhusus({super.key});

  @override
  State<ApprovalCutiKhusus> createState() => _ApprovalCutiKhususState();
}

class _ApprovalCutiKhususState extends State<ApprovalCutiKhusus> {
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const NeedConfirmCutiKhusus(),
                        ),
                      );
                    },
                    child: const Text(
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const LogCutiKhusus(),
                        ),
                      );
                    },
                    child: const Text(
                ...
                child: DataTable(
                  ...
                  rows: isFetchingData
                      ...
                      : List<DataRow>.generate(
                          dataApprovalCutiKhusus.length,
                          (int index) {
                            int rowIndex = (page - 1) * pageSize + index + 1;
                            return DataRow(
                              cells: <DataCell>[
                                DataCell(Text(rowIndex.toString())),
                                DataCell(Text(dataApprovalCutiKhusus[index]
                                    ['nama_karyawan'])),
                                DataCell(Text(
                                    dataApprovalCutiKhusus[index]['judul'])),
                                DataCell(Text(
                                    '${dataApprovalCutiKhusus[index]['tanggal_awal']} - ${dataApprovalCutiKhusus[index]['tanggal_akhir']}')),
                                DataCell(Text(dataApprovalCutiKhusus[index]
                                        ['jumlah_hari']
                                    .toString())),
                                DataCell(Text(
                                    dataApprovalCutiKhusus[index]['status'])),
                              ],
                            );
                          },
                        ),
          ...
          Row(
            ...
            children: [
              ...
              IconButton(
                ...
                onPressed: dataApprovalCutiKhusus.length >= pageSize
                    ? () => onPageChange(page + 1)
                    : null,
              ),
            ],
