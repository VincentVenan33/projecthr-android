...
import '../../color.dart';
import '../../services/laporan/perjalanan_dinas_service/export_laporan_perjalanan_dinas_service.dart';
import '../../services/laporan/perjalanan_dinas_service/get_laporan_perjalanan_dinas_service.dart';
import '../../util/customappbar.dart';

class LaporanCutiDinas extends StatefulWidget {
  final int id;
  const LaporanCutiDinas({super.key, required this.id});

  @override
  State<LaporanCutiDinas> createState() => _LaporanCutiDinasState();
}

class _LaporanCutiDinasState extends State<LaporanCutiDinas> {
  ...
  Future<void> fetchData() async {
    ...
    final result =
        await GetLaporanPerjalananDinasService().getLaporanPerjalananDinas(
      widget.id,
      page: page,
      tanggalAwal: tglAwal,
  ...
  Future<void> _downloadExcel() async {
    final hasil = await DownloadLaporanPerjalananDinasService()
        .downloadLaporanPerjalananDinas(
      widget.id,
      context,
      tanggalAwal: tglAwal,
      filterNama: filterNama,
    ...
    var file = '${dir?.path}/LaporanPerjalananDinas.xlsx';
