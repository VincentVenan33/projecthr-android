...
import '../../color.dart';
import '../../services/laporan/cuti_tahunan_service/export_laporan_cuti_tahunan_service.dart';
import '../../services/laporan/cuti_tahunan_service/get_laporan_cuti_tahunan_service.dart';
import '../../util/customappbar.dart';

class LaporanCutiTahunan extends StatefulWidget {
  final int id;
  const LaporanCutiTahunan({super.key, required this.id});
...
class _LaporanCutiTahunanState extends State<LaporanCutiTahunan> {
  ...
  Future<void> fetchData() async {
    ...
    final result = await GetLaporanCutiTahunanService().getLaporanCutiTahunan(
      widget.id,
      page: page,
      tanggalAwal: tglAwal,
  ...
  Future<void> _downloadExcel() async {
    final hasil =
        await DownloadLaporanCutiTahunanService().downloadLaporanCutiTahunan(
      widget.id,
      context,
      tanggalAwal: tglAwal,
      filterNama: filterNama,
    ...
    if (status.isGranted) {
      ...
      // var file = '${dir?.path}/LaporanCutiTahunan.xlsx';
      var file = '${generalDownloadDir.path}/LaporanCutiTahunan.xlsx';
                          ...
                          return DataRow(
                            cells: [
                              ...
                              DataCell(Text(dataCutiKhusus[index]['jumlah_hari']
                                  .toString())),
                              DataCell(Text(dataCutiKhusus[index]['sisa_kuota']
                                  .toString())),
