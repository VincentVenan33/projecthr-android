...
class _DetailPerjalananDinasState extends State<DetailPerjalananDinas> {
  ...
  void initState() {
    super.initState();
    fetchData();
    futureData = DetailPerjalananDinasService().detailPerjalananDinas(widget.id)
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  if (files?.isEmpty ?? true) {
                    ...
                    PerjalananDinasConfirmService().perjalananDinasConfirm(
                      idPerjalananDinas,
                      context,
                    );
                  } else {
