...
import '../../services/pengajuan_hr_services/perjalanan_dinas/hr_perjalanan_dinas_confirm_service.dart';
...
class HRDetailPerjalananDinas extends StatefulWidget {
  final int idPerjalananDinas;
  final int id;
  const HRDetailPerjalananDinas({
    super.key,
    required this.idPerjalananDinas,
    required this.id,
  });

  @override
  State<HRDetailPerjalananDinas> createState() =>
      _HRDetailPerjalananDinasState();
}
...
class _HRDetailPerjalananDinasState extends State<HRDetailPerjalananDinas> {
  ...
  void initState() {
    super.initState();
    fetchData();
    futureData = HRDetailPerjalananDinasService()
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          const Text(
            'HR Detail Cuti Perjalanan Dinas',
            style: TextStyle(
              fontSize: 20,
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  ElevatedButton(
                                    ...
                                    onPressed: () {
                                      HRPerjalananDinasDeleteService()
                                          .hrperjalananDinasDelete(
                                        idPerjalananDinas,
                                        context,
                                      );
                                      Navigator.pop(context);
