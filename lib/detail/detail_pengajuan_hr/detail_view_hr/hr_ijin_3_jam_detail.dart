...
class HRIjin3JamDetail extends StatefulWidget {
  final int id;
  const HRIjin3JamDetail({super.key, required this.id});

  @override
  State<HRIjin3JamDetail> createState() => _HRIjin3JamDetailState();
}

class _HRIjin3JamDetailState extends State<HRIjin3JamDetail> {
