...
import 'detail_log/detail_log_perjalanan_dinas.dart';

class LogPerjalananDinas extends StatefulWidget {
  const LogPerjalananDinas({super.key});

  @override
  State<LogPerjalananDinas> createState() => _LogPerjalananDinasState();
}

class _LogPerjalananDinasState extends State<LogPerjalananDinas> {
                        ...
                        return DataRow(
                          onLongPress: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => PerjalananDinasDetailLog(
                                  id: dataLogPerjalananDinas[index]['id'],
                                ),
                              ),
                            );
                          },
                          cells: <DataCell>[
                            ...
                            DataCell(Text(dataLogPerjalananDinas[index]
                                ['nama_karyawan'])),
                            DataCell(
                                Text(dataLogPerjalananDinas[index]['judul'])),
                            DataCell(Text(
                                '${dataLogPerjalananDinas[index]['tanggal_awal']} - ${dataLogPerjalananDinas[index]['tanggal_akhir']}')),
                            DataCell(Text(dataLogPerjalananDinas[index]
                                    ['jumlah_hari']
                                .toString())),
                            DataCell(
                                Text(dataLogPerjalananDinas[index]['status'])),
                          ],
                        );
                      },
                    ),
          ...
          Row(
            ...
            children: [
              ...
              IconButton(
                ...
                onPressed: dataLogPerjalananDinas.length >= pageSize
                    ? () => onPageChange(page + 1)
                    : null,
              ),
            ],
