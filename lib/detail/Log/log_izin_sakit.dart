...
import 'package:project/detail/Log/detail_log/detail-log_izin_sakit.dart';
import 'package:project/services/approval/izin_sakit_services/log_izin_sakit_list_services.dart';
// import '.../util/navbar.dart';
import 'package:project/util/navhr.dart';

import '../../util/customappbar.dart';

class LogIzinSakit extends StatefulWidget {
  const LogIzinSakit({super.key});

  @override
  State<LogIzinSakit> createState() => _LogIzinSakitState();
}

class _LogIzinSakitState extends State<LogIzinSakit> {
  ...
  Future<void> fetchData() async {
    ...
    final result = await LogIzinSakitListServices().logIzinSakitList(
      page: page,
                        ...
                        return DataRow(
                          onLongPress: () {
                            ...
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => IzinSakitDetailLog(
