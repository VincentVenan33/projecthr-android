...
import 'package:project/services/approval/cuti_tahunan_services/get_detail_cuti_tahunan_services.dart';
...
class DetailNeedConfirmCutiTahunan extends StatefulWidget {
  final int id;
  const DetailNeedConfirmCutiTahunan({super.key, required this.id});

  @override
  State<DetailNeedConfirmCutiTahunan> createState() =>
      _DetailNeedConfirmCutiTahunanState();
}

class _DetailNeedConfirmCutiTahunanState
    extends State<DetailNeedConfirmCutiTahunan> {
  ...
  Future<void> fetchData() async {
    final result = await DetailApprovalCutiTahunanServices()
        .detailApprovalCutiTahunan(widget.id);
  ...
  void initState() {
    super.initState();
    fetchData();
    _futureData = DetailApprovalCutiTahunanServices()
        .detailApprovalCutiTahunan(widget.id) as Future<Map<String, dynamic>>?;
  }
                    ...
                    Row(
                      ...
                      children: [
                        ElevatedButton(
                          ...
                          onPressed: () {
                            HrRefuseCutiTahunanServices().hrResfuseCutiTahunan(
                              widget.id,
                              context,
                            );
                            fetchData();
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () {
                            HrApproveCutiTahunan().hrApproveCutiTahunan(
                              widget.id,
                              context,
                            );
                            fetchData();
