...
import '../../../services/approval/izin_3_jam_service/hr_get_detail_izin_3_jam_services.dart';
...
import '../../../services/pengajuan/izin_3_jam_service/get_attachment_izin_3_jam_service.dart';
import '../../../util/customappbar.dart';
import '../../../util/navhr.dart';

class DetailNeedConfirm3Jam extends StatefulWidget {
  final int id;
  const DetailNeedConfirm3Jam({super.key, required this.id});
...
class _DetailNeedConfirm3JamState extends State<DetailNeedConfirm3Jam> {
  ...
  void initState() {
    super.initState();
    fetchData();
    _futureData = HrDetailIzin3JamService().hrDetailIzin3Jam(widget.id)
                    ...
                    Row(
                      ...
                      children: [
                        ElevatedButton(
                          ...
                          onPressed: () {
                            HrRefusedIzin3JamService().hrRefusedIzin3Jam(
                              widget.id,
                              context,
                            );
                          },
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () {
                            HrApproveIzin3JamService().hrApproveIzin3Jam(
                              widget.id,
                              context,
                            );
                          },
