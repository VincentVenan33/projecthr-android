...
class DetailNeedConfirmIzinSakitViewTable extends StatefulWidget {
  final int id;
  const DetailNeedConfirmIzinSakitViewTable({super.key, required this.id});

  @override
  State<DetailNeedConfirmIzinSakitViewTable> createState() =>
      _DetailNeedConfirmIzinSakitViewTableState();
}

class _DetailNeedConfirmIzinSakitViewTableState
    extends State<DetailNeedConfirmIzinSakitViewTable> {
  ...
  Future<void> fetchData() async {
    ...
    izinSakitdata = result;
    judulSakit.text = izinSakitdata['judul'];
    tglAwalController.text = izinSakitdata['tanggal_awal'];
    tglAkhirController.text = izinSakitdata['tanggal_akhir'];
    // jumlahHariController.text = izinSakitdata['jumlah_hari'].toString();

    // Format Tanggal Awal
    final inputDateAwal = izinSakitdata['tanggal_awal'];
    ...
    final inputDateAkhir = izinSakitdata['tanggal_akhir'];
        ...
        body: FutureBuilder<Map<String, dynamic>>(
          ...
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              final izinSakitdata = snapshot.data ?? {};
              return Form(
                key: formKey,
                child: ListView(
                    ...
                    Row(
                      ...
                      children: [
                        ElevatedButton(
                          ...
                          onPressed: () {
                            HrRefuseIzinSakitServices().hrResfuseIzinSakit(
                              widget.id,
                              context,
                            );
                            fetchData();
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () {
                            HrApproveIzinSakitServices().hrApproveIzinSakit(
                              widget.id,
                              context,
                            );
                            fetchData();
