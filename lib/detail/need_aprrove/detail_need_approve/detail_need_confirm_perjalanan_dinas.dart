...
import '../../../services/approval/perjalanan_dinas_service/perjalanan_dinas_detail_service.dart';
...
class DetailNeedConfirmPerjalananDinas extends StatefulWidget {
  final int id;
  const DetailNeedConfirmPerjalananDinas({super.key, required this.id});

  @override
  State<DetailNeedConfirmPerjalananDinas> createState() =>
      _DetailNeedConfirmPerjalananDinasState();
}

class _DetailNeedConfirmPerjalananDinasState
    extends State<DetailNeedConfirmPerjalananDinas> {
  ...
  Future<void> fetchData() async {
    final result = await DetailApprovalPerjalananDinasService()
        .detailApprovalPerjalananDinas(widget.id);

    dataLogPerjalananDinas = result;
    judulcutiController.text = dataLogPerjalananDinas['judul'];
    tanggalAwalController.text = dataLogPerjalananDinas['tanggal_awal'];
    tanggalAkhirController.text = dataLogPerjalananDinas['tanggal_akhir'];
    jumlahHariController.text =
        dataLogPerjalananDinas['jumlah_hari'].toString();

    // Format Tanggal Awal
    final inputDateAwal = dataLogPerjalananDinas['tanggal_awal'];
    ...
    final inputDateAkhir = dataLogPerjalananDinas['tanggal_akhir'];
  ...
  void initState() {
    super.initState();
    fetchData();
    _futureData = DetailApprovalPerjalananDinasService()
            .detailApprovalPerjalananDinas(widget.id)
        ...
        body: FutureBuilder<Map<String, dynamic>>(
          ...
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              final dataLogPerjalananDinas = snapshot.data ?? {};
              return Form(
                key: formKey,
                child: ListView(
