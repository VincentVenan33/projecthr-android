...
import '../../services/pengajuan_hr_services/perjalanan_dinas/hr_perjalanan_dinas_delete_attachment_service.dart';
import '../../services/pengajuan_hr_services/perjalanan_dinas/hr_perjalanan_dinas_detail_service.dart';
import '../../services/pengajuan_hr_services/perjalanan_dinas/hr_perjalanan_dinas_edit_service.dart';
import '../hr_pengajuan_perjalanan_dinas.dart';

class HREditPerjalananDinas extends StatefulWidget {
  final int id;
  const HREditPerjalananDinas({super.key, required this.id});
...
class _HREditPerjalananDinasState extends State<HREditPerjalananDinas> {
  ...
  Future<void> deleteAttachment(int index) async {
    ...
    final service = HRPerjalananDinasDeleteAttachmentService();
    await service.hrperjalananDinasDeleteAttachment(
        idIjin, attachmentId, context);
    setState(() {
