...
import '../../services/pengajuan_hr_services/cuti_khusus/hr_cuti_khusus_delete_attachment_service.dart';
import '../../services/pengajuan_hr_services/cuti_khusus/hr_cuti_khusus_detail_service.dart';
import '../../services/pengajuan_hr_services/cuti_khusus/hr_cuti_khusus_edit_service.dart';
import '../hr_pengajuan_cuti_khusus.dart';

class HREditCutiKhusus extends StatefulWidget {
  final int id;
  const HREditCutiKhusus({super.key, required this.id});
...
class _HREditCutiKhususState extends State<HREditCutiKhusus> {
  ...
  Future<void> deleteAttachment(int index) async {
    ...
    final service = HRCutiKhususDeleteAttachmentService();
    await service.hrcutiKhususDeleteAttachment(
      idIjin,
      attachmentId,
      context,
    );
  ...
  void initState() {
    super.initState();
    fetchData();
    _futureData = HRDetailCutiKhususService().hrdetailCutikhusus(widget.id)
                        ...
                        onPressed: () {
                          ...
                          if (formKey.currentState!.validate()) {
                            ...
                            if (dataCutiKhusus['status'] == 'Draft') {
                              ...
                              HRCutiKhususEditService().hrcutiKhususEdit(
                                widget.id,
