...
import '../../services/pengajuan_hr_services/izin_3_jam_services/hr_data_edit_izin_3_jam_service.dart';
import '../../services/pengajuan_hr_services/izin_3_jam_services/hr_delete_attachment_izin_3_jam_service.dart';
import '../../services/pengajuan_hr_services/izin_3_jam_services/hr_edit_ijin_3_jam_service.dart';
import '../../util/navhr.dart';
import '../hr_pengajuan_pembatalan_izin_3jam.dart';

class HREditPengajuanIjin3Jam extends StatefulWidget {
  final int id;
  const HREditPengajuanIjin3Jam({super.key, required this.id});

  @override
  State<HREditPengajuanIjin3Jam> createState() =>
      _HREditPengajuanIjin3JamState();
}

class _HREditPengajuanIjin3JamState extends State<HREditPengajuanIjin3Jam> {
  ...
  Future<void> fetchData() async {
    final result = await DataEditIzin3JamHRService()
        .dataEditIzin3JamHR(widget.id, context);
  ...
  Future<void> deleteAttachment(int index) async {
    ...
    final service = DeleteAttachmentIzin3JamHRService();
    await service.deleteAttachmentIzin3JamHR(idIjin, attachmentId, context);
    setState(() {
  ...
  void initState() {
    ...
    fetchData();
    _futureData =
        DataEditIzin3JamHRService().dataEditIzin3JamHR(widget.id, context)
                          ...
                          onPressed: () {
                            ...
                            if (formkey.currentState!.validate()) {
                              ...
                              if (dataIzin3Jam['status'] == 'Draft') {
                                ...
                                EditIzin3JamHRService().editIzin3JamHR(
                                  widget.id,
