...
import '../../color.dart';
import '../detail/detail_pengajuan_hr/detail_view_hr/perjalanan_dinas_detail_hr.dart';
import '../services/pengajuan_hr_services/perjalanan_dinas/hr_list_karyawan_service.dart';
import '../services/pengajuan_hr_services/perjalanan_dinas/hr_perjalanan_dinas_cancelled_service.dart';
import '../services/pengajuan_hr_services/perjalanan_dinas/hr_perjalanan_dinas_delete_service.dart';
import '../services/pengajuan_hr_services/perjalanan_dinas/hr_perjalanan_dinas_input_service.dart';
import '../services/pengajuan_hr_services/perjalanan_dinas/hr_perjalanan_dinas_list_service.dart';
import '../util/customappbar.dart';
import '../util/navhr.dart';
import 'hr_edit_pengajuan/hr_edit_perjalanan_dinas.dart';

String judulPerjalananDinas = '';
String tglAwal = '';
String tglAkhir = '';
...
class HRPengajuanPerjalananDinas extends StatefulWidget {
  ...
  @override
  State<HRPengajuanPerjalananDinas> createState() =>
      _HRPengajuanPerjalananDinasState();
}

class _HRPengajuanPerjalananDinasState
    extends State<HRPengajuanPerjalananDinas> {
  ...
  Future<void> fetchData() async {
    ...
    final result =
        await HRPerjalananDinasListService().gethrPerjalananDinasList(
      page: page,
                                            ...
                                            ElevatedButton(
                                              ...
                                              onPressed: () async {
                                                if (formkey.currentState!
                                                    .validate()) {
                                                  HRInputPerjalananDinasService()
                                                      .hrInputPerjalananDinas(
                                                    selectedId!,
                                ...
                                return DataRow(
                                  onLongPress: () {
                                    Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                        builder: (context) =>
                                            HRPerjalananDinasDetail(
                                          id: dataPerjalananDinas[index]['id'],
                                        ),
                                      ),
                                    );
                                  },
                                  cells: [
                                    ...
                                    DataCell(Text(dataPerjalananDinas[index]
                                        ['nama_karyawan'])),
                                    DataCell(Text(
                                        dataPerjalananDinas[index]['judul'])),
                                    DataCell(Text(
                                        '${dataPerjalananDinas[index]['tanggal_awal']} - ${dataPerjalananDinas[index]['tanggal_akhir']}')),
                                    DataCell(Text(dataPerjalananDinas[index]
                                            ['jumlah_hari']
                                        .toString())),
                                    DataCell(Text(
                                        dataPerjalananDinas[index]['status'])),
                                    dataPerjalananDinas[index]['status'] ==
                                            'Draft'
                                        ? DataCell(
                                            Row(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        ElevatedButton(
                                                                          ...
                                                                          onPressed:
                                                                              () {
                                                                            Navigator.pop(context);
                                                                            HRPerjalananDinasCancelledService().hrperjalananDinasCancelled(
                                                                              dataPerjalananDinas[index]['id'],
                                                                              context,
                                                                            );
                ...
                Row(
                  ...
                  children: [
                    ...
                    IconButton(
                      ...
                      onPressed: dataPerjalananDinas.length >= pageSize
                          ? () => onPageChange(page + 1)
                          : null,
                    ),
                  ],
